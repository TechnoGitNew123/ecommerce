              ...
              <?php } ?>
                ...
                <div class="card-body row">
                  <div class="form-group col-md-4 offset-md-2">
                    <input type="text" class="form-control form-control-sm" name="sale_bill_no" id="sale_bill_no" value="<?php if(isset($sale_bill_no)){ echo $sale_bill_no; } ?>" placeholder="Purchase Bill No." readonly>
                  </div>
                  ...
                  <div class="form-group col-md-4 offset-md-2 select_sm">
                    <select class="form-control select2  form-control-sm sale_challan_no" name="sale_challan_no" id="sale_challan_no" required>
                      <option selected="selected" value="">Select Delivery Challan No. for Purchase bill</option>
