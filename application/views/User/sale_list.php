        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card-header">
              <h3 class="card-title"><i class="fa fa-list"></i> List Sale Information</h3>
              <div class="card-tools">
                <a href="<?php echo base_url(); ?>Product/sale" class="btn btn-sm btn-block btn-primary">Add Sale</a>
              </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
